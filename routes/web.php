...
Route::get('nos-offres', function () {
    return view("prospections.nosOffre");
})->name('offre');
...
Route::get('affichage-de-agent/{agent}', [AgentController::class , 'AffichageAgt'])->name('agent.affichage');

Route::post('information-clt/', [ClientController::class , 'creerUnClient'])->name('clients.prospect');
/*
