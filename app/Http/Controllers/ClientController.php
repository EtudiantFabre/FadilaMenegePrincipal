...
class ClientController extends Controller
{
    ...
    public function creerUnClient(){
        //dd($_POST['service']);
        if (isset($_POST['id_agent']) && isset($_POST['service'])) {
            return view('clients.creerUnClient')->with('agent', $_POST['id_agent'])->with('service', $_POST['service']);    
        } else{
    ...
    {
        $client->delete();
        connectify('error', 'Suppression !', "Le client N° ".$client->id_client." à été supprimé avec succès !");
