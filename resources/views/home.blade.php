          ...
          <section class="col-lg-7 connectedSortable">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#sales-chart" data-toggle="tab">Diagramme</a>
                    </li>
                  </ul>
                </div>
              </div><!-- /.card-header -->
            ...
            <div class="card direct-chat direct-chat-primary">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <div class="direct-chat-text">
                      J'aimerais vous dire merci pour vos services!
                    </div>
                    <!-- /.direct-chat-text -->
                  </div>
                  <!-- /.direct-chat-msg -->
                  ...
                  <div class="direct-chat-msg right">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-right">Fadila ménage</span>
                      <span class="direct-chat-timestamp float-left">23 Jan 2:05 pm</span>
                    </div>
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{ asset('/Original.png') }}" alt="message d'image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                      Je vous en pris !
                    </div>
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                      Disposez-vous d'autres service comme les mécaniciens ?
                    </div>
                    <!-- /.direct-chat-text -->
                  </div>
                  <!-- /.direct-chat-msg -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{ asset('/Original.png') }}" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                      Non, nous n'effectuons des services que ceux cités.
                    </div>
                    <!-- /.direct-chat-text -->
                  </div>
                  <!-- /.direct-chat-msg -->
                ...
                <div class="direct-chat-contacts" style="display: none">
              ...
              <div class="card-footer">
                <form action="#" method="post">
                  <div class="input-group">
                    <input type="text" name="message" placeholder="Message ici ..." class="form-control">
