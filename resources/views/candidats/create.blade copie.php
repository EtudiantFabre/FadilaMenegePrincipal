...
<div class="container rounded-4 bg-warning shadow-lg p-3 mb-5 bg-div">
	...
	@endif
		...
		<div class="form-group">
			...
			<input type="text" name="nom" value="{{ isset($candidat->nom) ? $candidat->nom : old('nom') }}"  id="nom" placeholder="Votre nom" class="form-control" required>
		...
		<div class="form-group">
			...
			<input type="text" name="prenom" value="{{ isset($candidat->prenom) ? $candidat->prenom : old('prenom') }}"  id="prenom" placeholder="Votre prenom" class="form-control" required>
        ...
        <div class="form-group">
			<label for="situation_familiale" >Situation matrimoniale</label><span class="text-danger required" aria-hidden="true">*</span> :
            @if (isset($candidat))
