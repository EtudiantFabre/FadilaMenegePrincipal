                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="ville" id="ville" type="text" placeholder="Ville" required>
                                                @error("ville")
                                                    <div class="text-danger required">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="quartier" id="quartier" placeholder="Quartier" required>
                                                @error("quartier")
                                                <div class="text-danger required">{{ $message }}</div>
                                                @enderror
                                            </div>
