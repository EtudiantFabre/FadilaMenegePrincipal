                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" style="color: black" id="exampleModalLabel">INFOS POUR LA PROSPECTION</h5>
                                <!--button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button-->
                            </div>
                            <div class="modal-body">
                                <form>
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label text-info fw-bolder">Votre prospection sera enregistré avec succès. Veuilez patientez, vous recevrer un mail pour la confirmation !!!</label>
                                    </div>
                                
                                </form>
                            </div>
                            
                            <div class="d-grid gap-2 col-6 mx-auto modal-footer" data-bs-toggle="modal" data-bs-target="#exampleModal">
