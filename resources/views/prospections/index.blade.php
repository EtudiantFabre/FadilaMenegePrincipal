...
<body>
    <br>
    <br>
    <div class="container rounded-4 bg-transparent shadow-lg p-3 mb-5 bg-div">
        <h1 class="text-center">Liste des prospections</h1>
        <div>
            <form action="{{route('prospections.create')}}">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end" >
                    <button type="submit" class="btn btn-primary" disabled>CREER UNE PROSPECTION</button>
                </div>
            </form>
        </div>
        <br>
                    ...
                    <td>
                        <div class="d-flex dropdown mr-1">
                            ...
                            <form action="{{route('prospections.edit', $prospection->id_prospection)}}" method="GET">
                                @csrf
                                <button type="submit" class="btn btn-outline-info" disabled>Modifier</button>
                            </form>
                        </div>
                    </td>
                </tr>
