            ...
            <table class="table table-primary table-hover table-striped table-bordered border-primary text-center justify-content-center">
                ...
                @foreach ($persAprev as $personne)
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-success btn-block" href="{{ route('personneAprevenirs.edit', $personne) }}" >Modifier</button>
                        </td>

                        <td>
                            <a class="btn btn-info btn-block" href="{{ route('personneAprevenirs.show', $personne) }}" title="Afficher">Afficher</a>
                        </td>
                        <td>
